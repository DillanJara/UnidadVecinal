...
CREATE UNIQUE INDEX `ADMINISTRADOR__IDX` ON `ADMINISTRADOR` (`MIEMBRO_mie_rut`);
...
ALTER TABLE `ACTIVIDAD` ADD CONSTRAINT `ACTIVIDAD_ADMINISTRADOR_FK` FOREIGN KEY (`ADMINISTRADOR_adm_id`) REFERENCES `ADMINISTRADOR` (`adm_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `ADMINISTRADOR` ADD CONSTRAINT `ADMINISTRADOR_MIEMBRO_FK` FOREIGN KEY (`MIEMBRO_mie_rut`) REFERENCES `MIEMBRO` (`mie_rut`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `NOTICIA` ADD CONSTRAINT `NOTICIA_ADMINISTRADOR_FK` FOREIGN KEY (`ADMINISTRADOR_adm_id`) REFERENCES `ADMINISTRADOR` (`adm_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
