...
class AgregarActividad(forms.ModelForm):
    ...
    act_descripcion        = forms.CharField(label="Descripcion", max_length=30, widget=forms.Textarea(attrs={"rows": "3"}))
    act_cupo               = forms.IntegerField(label="Cupo", help_text="Disponibilidad para la Actividad", min_value=10, max_value=200)
